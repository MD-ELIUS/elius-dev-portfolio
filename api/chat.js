...
function isPortfolioTopic(text) {
    const topics = /(portfolio|project|projects|experience|skill|skills|resume|cv|github|linkedin|about|contact|service|services|website|md\.? eli?us|elius|md elius|tech stack|technolog|tailor|react|node|express|mongodb|work|education|expertise|background|qualification|who|what|hire|business|create|build|code|develop|fullstack|full-stack|frontend|backend|sql|database|language|framework|python|java|javascript|typescript|css|html|api|rest|graphql|lamp|mern|mevn|bootstrap|vuejs|vue|angular|aws|docker|git|linux|windows|mac)/i;
...
export default async function handler(req, res) {
    ...
    // Enforce portfolio-only responses: refuse if not about the portfolio/owner
    ...
    const systemPrompt = `YOU ARE: MD. Elius, Full-Stack Developer & Digital Creator
